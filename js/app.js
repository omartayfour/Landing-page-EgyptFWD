 ...
 */
 ...
 const navUpButton = document.createElement("i");
 ...
 function scrollHelperFunction() {
     for (let i = 1; i <= mySections.length; i++) {
         ...
         if ((rect.bottom <= window.innerHeight && rect.top >= 0) || (rect.y <= 0 && rect.y >= -577)) {
             ...
             const mySection = document.querySelector("#section" + i);
             removeActiveClass();
 ...
 function navigateToSection(event) {
     ...
     const section = event.target.textContent.split(" ")[1];
     const mySection = document.querySelector("#section" + section);
